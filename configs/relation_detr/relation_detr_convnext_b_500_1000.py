...
backbone = ConvNeXtBackbone("conv_b", weights="/data/minkyu/Kaist/Relation-DETR/convnext_b_backbone/aug_base_epoch13_val0.8099.pth", return_indices=(1, 2, 3), freeze_indices=())
...
postprocessor = PostProcess(select_box_nums_for_evaluation=5) ################
