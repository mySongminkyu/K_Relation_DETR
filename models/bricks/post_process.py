...
class PostProcess(nn.Module):
    ...
    def __init__(
        self,
        select_box_nums_for_evaluation=5, ##########################
        nms_iou_threshold=-1,
        confidence_score=-1,
    ):
        super().__init__()
    ...
    def forward(self, outputs, target_sizes):
        ...
        #   총 score 개수 = num_queries * num_classes
        total_scores = prob.view(out_logits.shape[0], -1).shape[1]
        k = min(self.select_box_nums_for_evaluation, total_scores)
