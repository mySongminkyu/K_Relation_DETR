# PYTHONPATH=. CUDA_VISIBLE_DEVICES=2 python models/backbones/convnext_classifier_aug.py
...
# -------------------------------------------------
# 7. DataLoader (WeightedRandomSampler 적용)
# -------------------------------------------------
class_weights = torch.tensor([1.0, neg / pos]).to(device)
...
import wandb
wandb.init(project="convnext_binary_cls", name="ConvNeXt-S_sampler_aug", config={
...
for epoch in range(total_epochs):
    ...
    # Top-K 저장
    save_path = os.path.join(save_dir, f"aug_small_epoch{epoch+1:02d}_val{val_acc:.4f}.pth")
